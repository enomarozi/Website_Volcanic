class DispersionService:
    ...
    def simulate(self, particles, duration, dt):
        if not particles:
        ...
        for particle_index, particle in enumerate(particles):
            ...
            particle_id = particle.get("id", particle_index + 1)
            ...
            for step in range(1, steps + 1):
                ...
                time_index = self.meteorology.time_index_at_elapsed(elapsed_time)
        ...
        return {
            ...
            "total_particles": sum(int(p.get("count", 1)) for p in particles),
